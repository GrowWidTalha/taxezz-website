...
const Footer = () => {
    ...
    return (
        <footer className="w-full bg-white text-gray-700 pb-4">
            <div className="container mx-auto px-4 md:px-6">
                ...
                {/* Footer Bottom */}
                <div className={`flex ${isMobile ? 'flex-col space-y-4' : 'flex-row justify-between'} items-center text-sm text-gray-500`}>
